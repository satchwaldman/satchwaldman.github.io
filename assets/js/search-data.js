      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "books-policy-paradox",
          title: 'Policy Paradox',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/policy-paradox/";
          ...
          description: "",
          section: "News",},{id: "projects-digital-brain",
          title: 'Digital Brain',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%61%74%63%68@%6D%69%74.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/satchwaldman", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/satch-sumner-waldman", "_blank");
        },
      },{
      id: 'light-theme',
